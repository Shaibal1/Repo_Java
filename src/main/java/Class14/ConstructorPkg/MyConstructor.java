...
{
    /**
     * Constructor: It'sa special method
     * 1. It has SAME name as of the class
     * 2. It does NOT have a return type,not even VOID.
     * 3. In order to create an object of class, java runs its Constructor method.
     ...
     *                  (when we have all method/variables as static)
     *
     *  2. Constructor can have arguments as well.
     *  3. We can have one or more method with the same in a class. --> Compile Time Polymorhism (MethodOverloading)
     *  4. We can have one or more Constructors in a class. --> Constructor Overloading (MethodOverloading)
     *  5. If user defined Constructor is present in the class, Java never creates a default Constructor.
     *
     *
     *
     * */
