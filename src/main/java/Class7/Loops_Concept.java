...
//        System.out.println("Hello World");  // i = 5    i <= 5
        ...
        String[] threeWordSentence = new String[]{"hApPy", "nEW", "yeAr","TO","You","DeAr"};
        String result = "";
        ...
        String fourthWord = threeWordSentence[3].substring(0, 1).toUpperCase() + threeWordSentence[3].substring(1).toLowerCase();
        String fifthWord = threeWordSentence[4].substring(0, 1).toUpperCase() + threeWordSentence[4].substring(1).toLowerCase();
        String sixthWord = threeWordSentence[5].substring(0, 1).toUpperCase() + threeWordSentence[5].substring(1).toLowerCase();

        System.out.println("Answer to Question 1:'"+firstWord+"'," + "'"+secondWord + "'," + "'" + thirdWord + "'," + "'"+ fourthWord +"'," + "'"+ fifthWord +"'," + "'"+ sixthWord +"'");

        for (int i =0; i<threeWordSentence.length-1;i++)
        {
            result = result + " " + threeWordSentence[i].substring(0,1).toUpperCase()+ threeWordSentence[i].substring(1);
